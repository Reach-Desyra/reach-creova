    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Move from sketches or CAD designs to presentation-ready visuals quickly. Reduce back-and-forth and speed up internal approvals, helping teams bring collections to market faster.
          </p>
