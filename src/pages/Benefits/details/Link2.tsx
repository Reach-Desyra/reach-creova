    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Deliver consistently premium visuals that reflect craftsmanship, detail, and quality. High-impact imagery builds trust and positions your brand as modern and design-forward.
          </p>
