...
const Footer = () => {
  const footerLinks = [
    { label: "About REACH Creova", path: "/about" },
    { label: "Benefits of REACH Creova", path: "/benefits" },
    // { label: "Learning Guides", path: "/learningguide" },
    // { label: "Presentations", path: "/presentations" },
    // { label: "REACH Sophis Images", path: "/rmmimages" },
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <Link to="/" className="text-2xl font-bold mb-4 block w-fit">
              <span className="text-primary">REACH</span> Creova
            </Link>
            <p className="text-gray-300 max-w-md">
              Best In Class Photo and Image Editing Software for Jewellery Design
            </p>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                <img src={emailIcon} alt="Email icon for REACH Sophis" className="w-8 icon-a31951" />
              ...
              >
                <img src={whatsappIcon} alt="Whatsapp icon for REACH Sophis" className="w-8 icon-a31951" />
                <span className="text-gray-300 text-lg">
                  +91 84592 78496
                </span>
              </a>
              ...
              >
                <img src={contactIcon} alt="Contact form icon for REACH Sophis" className="w-7 icon-a31951" />
                <span className="text-gray-300 text-lg">
                  Write to Us
                </span>
              </a>
